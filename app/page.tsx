      ...
      <section className="pt-24 pb-24 gradient-bg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            >
              <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-24 leading-relaxed">
                Modern Data Analytics for
                <span className="text-gradient block mt-6 mb-4">Tomorrow's Challenges</span>
              </h1>
